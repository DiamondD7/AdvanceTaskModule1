...
namespace Talent.Services.Profile.Models.Profile
{
    public class TalentProfileViewModel
    {
        ...
        public DateTime? VisaExpiryDate { get; set; } /*havent added this to the profileservice getTalentProfile method*/
        public string ProfilePhoto { get; set; }
        public string ProfilePhotoUrl { get; set; }

        public string VideoName { get; set; }
        public string VideoUrl { get; set; } /*havent added this to the profileservice getTalentProfile method*/
        public string CvName { get; set; }
        public string CvUrl { get; set; } /*havent added this to the profileservice getTalentProfile method*/
        public string Summary { get; set; }
        public string Description { get; set; }
        public LinkedAccounts LinkedAccounts { get; set; }
        public JobSeekingStatus JobSeekingStatus { get; set; }

        public List<AddLanguageViewModel> Languages { get; set; } /*havent added ALL THE LIST to the profileservice getTalentProfile method*/
